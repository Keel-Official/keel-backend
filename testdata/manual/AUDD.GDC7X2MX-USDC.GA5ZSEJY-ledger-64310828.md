# Layer 1 hand recomputation: AUDD/USDC at ledger 64310828
...
> Source input: `docs/evidences/layer-1/AUDD-USDC-64310828.md`.
> Note: the thin end — 11 bids, 5 asks. Start here (lowest cost of a method error).
...
|---|---|---|
| Base asset | — | AUDD |
| Issuer address (G + 55 chars, INSIDE the file) | **YES** | `GDC7X2MXTYSAKUUGAIQ7J7RPEIM7GXSAIWFYWWH4GLNFECQVJJLB2EEU` |
| Quote asset | — | USDC |
...
### 1a. Bids — amount denominated in USDC (counter asset), see Section 2 (11 levels)
...
### 1b. Asks — amount denominated in the base asset (AUDD) (5 levels)

| # | price_r n | price_r d | amount (AUDD) |
|---|---|---|---|
| 0 | | | |
| 1 | | | |
| 2 | | | |
