# Layer 1 hand recomputation: PYUSD/USDC at ledger 64310828
...
> Source input: `docs/evidences/layer-1/PYUSD-USDC-64310828.md`.
> Note: a `credit_alphanum12` code — the asset type is not inferred from code length.
...
|---|---|---|
| Base asset | — | PYUSD |
| Issuer address (G + 55 chars, INSIDE the file) | **YES** | `GDQE7IXJ4HUHV6RQHIUPRJSEZE4DRS5WY577O2FY6YQ5LVWZ7JZTU2V5` |
| Quote asset | — | USDC |
| Quote issuer | — | `GA5ZSEJYB37JRC5AVCIA5MOP4RHTM335X2KGX3IHOJAPP5RE34K4KZVN` |
| **Ledger:** (word `Ledger` + ≥5 digits) | **YES** | 64310828 |
| Source / provenance | reported | Horizon order_book + liquidity_pools, recorded 2026-09-07T04:11:19Z |
...
### 1a. Bids — amount denominated in USDC (counter asset), see Section 2 (27 levels)
...
### 1b. Asks — amount denominated in the base asset (PYUSD) (15 levels)

| # | price_r n | price_r d | amount (PYUSD) |
|---|---|---|---|
| 0 | | | |
| 1 | | | |
| 2 | | | |
...
go run ./cmd/keel layer1 \
  -recording docs/evidences/layer-1/raw/PYUSD-USDC-64310828.json.gz \
  -after-writing testdata/manual/PYUSD.GDQE7IXJ-USDC.GA5ZSEJY-ledger-64310828.md
```
