# Layer 1 hand recomputation: BRL/USDC at ledger 64310828
...
> Source input: `docs/evidences/layer-1/BRL-USDC-64310828.md`.
> Note: the most asymmetric book here (35 bids vs 5 asks) — it presses hardest on the buy vs sell split.
...
|---|---|---|
| Base asset | — | BRL |
| Issuer address (G + 55 chars, INSIDE the file) | **YES** | `GDVKY2GU2DRXWTBEYJJWSFXIGBZV6AZNBVVSUHEPZI54LIS6BA7DVVSP` |
| Quote asset | — | USDC |
| Quote issuer | — | `GA5ZSEJYB37JRC5AVCIA5MOP4RHTM335X2KGX3IHOJAPP5RE34K4KZVN` |
| **Ledger:** (word `Ledger` + ≥5 digits) | **YES** | 64310828 |
| Source / provenance | reported | Horizon order_book + liquidity_pools, recorded 2026-09-07T04:11:21Z |
...
### 1a. Bids — amount denominated in USDC (counter asset), see Section 2 (35 levels)
...
### 1b. Asks — amount denominated in the base asset (BRL) (5 levels)

| # | price_r n | price_r d | amount (BRL) |
|---|---|---|---|
| 0 | | | |
| 1 | | | |
| 2 | | | |
...
go run ./cmd/keel layer1 \
  -recording docs/evidences/layer-1/raw/BRL-USDC-64310828.json.gz \
  -after-writing testdata/manual/BRL.GDVKY2GU-USDC.GA5ZSEJY-ledger-64310828.md
```
